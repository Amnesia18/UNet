...
if __name__ == '__main__':
    jpgs_path = "depthimage/JPEGImages"
    pngs_path = "depthimage/SegmentationClass"
    # classes     = ["_background_","person", "car", "motorbike", "dustbin","chair","fire_hydrant","tricycle","bicycle","stone"]
    classes = ["_background_", "duck"]

    count = os.listdir("./depthimage/imageData")
    for i in range(0, len(count)):
        path = os.path.join("./depthimage/imageData", count[i])
